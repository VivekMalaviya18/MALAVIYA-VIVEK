        ...
        <section id="education" className="py-16 bg-cover bg-center">
            ...
            <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 px-4">
                {EDUCATION.map((item, id) => (
                    <motion.div
                        key={id}
                        className="relative rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-transform duration-300 border-l-4 border-orange-400 backdrop-blur-md bg-white/10"
                    ...
                    >
                        {/* Icon */}
                        <div className="absolute -top-6 left-4 bg-orange-300 p-3 rounded-full shadow-xl">
                            <FaGraduationCap className="text-2xl text-black" />
                        </div>

                        {/* Degree */}
                        <h3 className="font-semibold text-xl lg:text-2xl mb-2 text-orange-300">
                            {item.degree}
                        </h3>
